...
const Vimeo = {
    name: 'Vimeo',
    icon: '<img src="https://upload.wikimedia.org/wikipedia/commons/9/9c/Vimeo_Logo.svg" alt="Vimeo" title="Vimeo" class="platform-icon">',
    iconUrl: 'https://upload.wikimedia.org/wikipedia/commons/9/9c/Vimeo_Logo.svg',
