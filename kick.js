...
const Kick = {
    name: 'Kick',
    icon: '<img src="https://upload.wikimedia.org/wikipedia/commons/5/5f/Kick_logo.svg" alt="Kick" title="Kick" class="platform-icon">',
    iconUrl: 'https://upload.wikimedia.org/wikipedia/commons/5/5f/Kick_logo.svg',
